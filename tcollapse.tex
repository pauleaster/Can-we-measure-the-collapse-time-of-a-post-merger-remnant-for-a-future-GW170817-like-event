...
\title{Can we measure the collapse time of a post-merger remnant for a future GW170817-like event?}
...
\maketitle
    ...
    See Ref.~\cite{Sarin2020b} for a recent review on the evolution of neutron star merger remnants.
...
\par
    ...
    If a post-merger collapse event occurs at a sky location near the antenna pattern maximum then the maximum distance where we can measure $\tc$ will increase by $\sim\!60\%$.
    \par
...
\section{Discussion}\label{sec:discussion}
    ...
    The detection distance would increase by $\sim\!60\%$ near an optimal sky position. \par
...
\begin{figure}[h]
        \centering
        \includegraphics[scale=0.5]{{NRTCAnalyticRuns_index5.0_2xAplus_snr34.31_distance3.37_THC:0036:R03_tc10.0_ra2.37_dec1.49_seed9_znFalse_mod_corner}.pdf}
        \caption
